...
export interface ConstructContext<T> {
    ...
    construct<T1 extends keyof T, F extends new (d1: T[T1]) => S, S>(
        F: F,
        t1: T1
    ): SF<S>;
    ...
    construct<
        T1 extends keyof T,
        T2 extends keyof T,
        F extends new (d1: T[T1], d2: T[T2]) => S,
        S
    >(
        F: F,
        t1: T1,
    ...
    construct<
        ...
        T2 extends keyof T,
        T3 extends keyof T,
        F extends new (d1: T[T1], d2: T[T2], d3: T[T3]) => S,
        S
    >(
        F: F,
        t1: T1,
    ...
    construct<
        ...
        T3 extends keyof T,
        T4 extends keyof T,
        F extends new (d1: T[T1], d2: T[T2], d3: T[T3], d4: T[T4]) => S,
        S
    >(
        F: F,
        t1: T1,
...
export const createFeatureFactoryConstructContext = ({
    getService,
}: ServiceFunctionReferenceContainerInterface) => ({
    construct: constructServiceByTags(getService),
});

export const constructServiceByTags = (
    getServiceFactory: (tag: ServiceTag) => ServiceFactory
) => <Service>(
