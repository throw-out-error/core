...
import {
    defaultServiceKeys,
    DefaultServices,
} from "../Feature/defaultServicesKeys";
...
export interface MergeFeatureContext<Services> {
     ...
     */
    merge<T>(
        featureFactory: FeatureFactory<T, DefaultServices>
    ): MergeWith<DefaultServices & T>;

    /**
     * @typeGenerator({ templates: ["  merge<{{K% extends keyof Services }}>({{k%:K%}}): MergeWith<DefaultServices & Pick<Services, {{K% - | }}>>;\n"] })
     */
    merge<K1 extends keyof Services>(
        k1: K1
    ): MergeWith<DefaultServices & Pick<Services, K1>>;

    merge<K1 extends keyof Services, K2 extends keyof Services>(
        k1: K1,
        k2: K2
    ): MergeWith<DefaultServices & Pick<Services, K1 | K2>>;
    ...
    >(
        ...
        k2: K2,
        k3: K3
    ): MergeWith<DefaultServices & Pick<Services, K1 | K2 | K3>>;
    ...
    >(
        ...
        k3: K3,
        k4: K4
    ): MergeWith<DefaultServices & Pick<Services, K1 | K2 | K3 | K4>>;
    ...
    >(
        ...
        k4: K4,
        k5: K5
    ): MergeWith<DefaultServices & Pick<Services, K1 | K2 | K3 | K4 | K5>>;
    ...
    >(
        ...
        k5: K5,
        k6: K6
    ): MergeWith<DefaultServices & Pick<Services, K1 | K2 | K3 | K4 | K5 | K6>>;
    ...
    >(
        ...
        DefaultServices & Pick<Services, K1 | K2 | K3 | K4 | K5 | K6 | K7>
    >;
    ...
    >(
        ...
        DefaultServices & Pick<Services, K1 | K2 | K3 | K4 | K5 | K6 | K7 | K8>
    >;
    ...
    >(
        ...
        DefaultServices &
            Pick<Services, K1 | K2 | K3 | K4 | K5 | K6 | K7 | K8 | K9>
    >;
...
export const createFeatureMergeContext = (
    context: InternalContextContext
): MergeFeatureContext<any> => ({
    merge: mergeFeature(context) as any,
});

export const mergeFeature = <Services>({
    container,
    invoke,
}: InternalContextContext) => {
    const mergeWith = (
        previousContainer: ServiceFunctionReferenceContainerInterface
    ) => <S, Dependencies>(
        sf: FF<S, Services> | ServiceTag[]
    ): MergeWith<Services | Dependencies> => {
        ...
        return {
            ...
            services: services((...tags: ServiceTag[]) =>
                servicesByTags(current.getService)(...(tags as [ServiceTag]))
            ) as any,
            all: () => {
                return fromPairs(
                    current
    ...
    const defaultServices = new MergeServiceFunctionReferenceContainer(
        container
    );
