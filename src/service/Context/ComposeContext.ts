...
export interface ComposeContext<T> {
    ...
    compose<t1 extends keyof T, F extends (d1: T[t1]) => S, S>(
        f: F,
        k1: t1
    ): SF<S>;
    ...
    compose<
        ...
        t2 extends keyof T,
        t3 extends keyof T,
        F extends (d1: T[t1], d2: T[t2], d3: T[t3]) => S,
        S
    >(
        f: F,
        k1: t1,
    ...
    compose<
        ...
        t3 extends keyof T,
        t4 extends keyof T,
        F extends (d1: T[t1], d2: T[t2], d3: T[t3], d4: T[t4]) => S,
        S
    >(
        f: F,
        k1: t1,
    ...
    compose<
        ...
        t4 extends keyof T,
        t5 extends keyof T,
        F extends (d1: T[t1], d2: T[t2], d3: T[t3], d4: T[t4], d5: T[t5]) => S,
        S
    >(
        f: F,
        k1: t1,
...
export const composeServiceByTags = curryN(
    2,
    <Service>(
        ...
        return () =>
            serviceFactory(
                ...servicesByTags(getServiceFactory)(
                    ...(tags as [ServiceTag])
                ).map((sf: SF) => sf())
            );
    }
...
export const createFeatureFactoryComposeContext = (
