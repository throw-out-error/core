 ...
 */
export class ServiceFunctionReferenceContainer<Services = never>
    implements ServiceFunctionReferenceContainerInterface<Services> {
    public getService = ((tag: ServiceTag) => () =>
        this.serviceReferences.getService(tag).getProxy()()) as never;
    ...
    public add<TService>(
        ...
        reference.setContainerConfiguration({
            ...
            proxy: () => {
                ...
                this.dependencyCallStack = this.dependencyCallStack.add(
                    reference
                );
                try {
                    /**
                    ...
                    this.dependencyCallStack = this.dependencyCallStack.remove(
                        reference
                    );
                }
                return reference.getService();
        ...
        return reference.configuration.proxy as never;
    }
