...
import {
    ...
    ServiceFactoryReferenceOptions,
} from "./BaseServiceFactoryReference";
import { AsyncServiceFunctionReferenceError } from "./AsyncServiceFunctionReferenceError";

interface TaggedServiceFactoryReferenceOptions
    extends ServiceFactoryReferenceOptions {
...
export class TaggedServiceFactoryReference extends BaseServiceFactoryReference {
    ...
    public callServiceFactory(thisReference: Record<ServiceTag, SF>) {
        ...
        const overrides: OverrideFunction<
            unknown
        >[] = this.overrides.map((override) => (previous) =>
