// Credit goes to https://github.com/janrembold
...
export const easeInSine = (
    ...
    c: number,
    d: number
): number => -c * Math.cos((t / d) * (Math.PI / 2)) + c + b;
...
export const easeOutSine = (
    ...
    c: number,
    d: number
): number => c * Math.sin((t / d) * (Math.PI / 2)) + b;
...
export const easeInOutSine = (
    ...
    c: number,
    d: number
): number => (-c / 2) * (Math.cos((Math.PI * t) / d) - 1) + b;
...
export const easeInExpo = (
    ...
    c: number,
    d: number
): number => (t == 0 ? b : c * Math.pow(2, 10 * (t / d - 1)) + b);
...
export const easeOutExpo = (
    ...
    c: number,
    d: number
): number => (t == d ? b + c : c * (-Math.pow(2, (-10 * t) / d) + 1) + b);
...
export const easeInCirc = (
    ...
    c: number,
    d: number
): number => -c * (Math.sqrt(1 - (t /= d) * t) - 1) + b;
...
export const easeOutCirc = (
    ...
    c: number,
    d: number
): number => c * Math.sqrt(1 - (t = t / d - 1) * t) + b;
...
export const easeInBounce = (
    ...
    c: number,
    d: number
): number => c - easeOutBounce(d - t, 0, c, d) + b;
