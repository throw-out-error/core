import { ForbiddenException, ParamData } from "@toes/core";
import { CUSTOM_ROUTE_AGRS_METADATA } from "@toes/core/constants";
import { ContextType, Controller, PipeTransform } from "@toes/core/interfaces";
import { isEmpty, isFunction } from "@toes/core/utils/shared.utils";
...
export class ExternalContextCreator {
    ...
    static fromContainer(container: Container): ExternalContextCreator {
    ...
    public getMetadata<TMetadata, TContext extends string = ContextType>(
        ...
        const cacheMetadata = this.handlerMetadataStorage.get(
            instance,
            methodName
        );
        if (cacheMetadata) {
